  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 4 }}>
        <Typography variant='h5' fontWeight={600}>Thêm Nhân Sự Mới</Typography>
      ...
      <Box component='form' onSubmit={handleSubmit} sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 3, overflowY: 'auto' }}>
        <CustomTextField
          fullWidth
          label='Họ và tên *'
