...
// 🔐 Helper: luôn convert value sang Date hợp lệ hoặc null
const toSafeDate = val => {
  if (!val) return null            // null, undefined, '' → null
  ...
  return (
    <StyledReactDatePicker {...boxProps}>
      <ReactDatePickerComponent
        ...
        endDate={toSafeDate(endDate)}
        minDate={toSafeDate(minDate)}
        maxDate={toSafeDate(maxDate)}
        {...rest}
      />
